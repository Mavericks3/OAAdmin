...
public class AccountServiceImpl implements AccountService {
    ...
    public AccountDTO addAccount(AccountDTO accountDTO) {
        ...
        Optional<Customer> customer = customerRepository.findByCustomerIdAndTransactionStatus(accountDTO.getCustomer().getCustomerId(), TransactionStatusEnum.MASTER);
        if(customer.isEmpty())
            throw new RuntimeException("Customer with id " + accountDTO.getCustomer().getCustomerId() + " does not exist");
    ...
    public AccountDTO modifyAccount(AccountDTO accountDTO) {
        ...
        accountDetails.setCustomer(customer.get());
