package org.trishanku.oa.admin.jwtauthentication.configuration;
...
import org.trishanku.oa.admin.jwtauthentication.filter.JwtRequestFilter;
    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**").allowedOrigins(corsAllowedUrls);
            }
        };
    }
...
/*        CorsConfiguration corsConfiguration = new CorsConfiguration();
        ...
        httpSecurity.csrf().disable().cors().and()
                .authorizeRequests().antMatchers("/authenticate","/api/v1/userDetails/**").permitAll()
