...
(
    ...
    cable_charge_currency varchar(255),
    cable_charge_amount numeric(19,2),
    communication_charge_currency varchar(255),
    communication_charge_amount numeric(19,2),
    anchor_party_approval_required boolean,
    counter_party_approval_required boolean,
    auto_finance boolean,
    auto_settlement boolean,
    invoice_service_charge_currency varchar(255),
    invoice_service_charge_amount numeric(19,2),
    finance_service_charge_currency varchar(255),
    finance_service_charge_amount numeric(19,2),
    settlement_service_charge_currency varchar(255),
    settlement_service_charge_amount numeric(19,2),
...
(
    ...
    intrest_rate_type                  varchar(255),
    intrest_charge_type                varchar(255),
    ...
    agreement_id                       uuid
        constraint fk_sbrtable_agreementid
            references admin.agreement_table,
    anchor_customer_id                 uuid
    ...
    counter_party_id                   uuid
        constraint fk_sbrtable_counterparytid
            references admin.customer_table,
    rm_id                             uuid
        constraint fk_sbrtable_rmid
            references admin.rm_table,
    expiry_date                        timestamp,
    auto_finance                       boolean,
    auto_settlement                    boolean,
    financing_profit_margin_rate       real,
    anchor_party_approval_required     boolean,
    cable_charge_amount                numeric(19, 2),
    cable_charge_currency              varchar(255),
    communication_charge_amount        numeric(19, 2),
    ...
    finance_service_charge_amount      numeric(19, 2),
    finance_service_charge_currency    varchar(255),
    interest_charge_type               varchar(255),
